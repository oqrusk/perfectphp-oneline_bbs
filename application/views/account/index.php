...
<ul><?php foreach ($followings as $following): ?>
    <li>
    <a href="<?php echo $base_url; ?>/user/<?php echo $this->escape($following['user_name']); ?>"></a><?php echo $this->escape($following['user_name']); ?>
    </li>
    <?php endforeach; ?>
</ul>
<?php endif; ?>
